...
// .wrangler/tmp/bundle-1HuSBs/strip-cf-connecting-ip-header.js
...
function isZodType(schema, typeName) {
  var _a150;
  return ((_a150 = schema === null || schema === void 0 ? void 0 : schema._def) === null || _a150 === void 0 ? void 0 : _a150.typeName) === typeName;
}
...
function extendZodWithOpenApi(zod) {
  ...
  zod.ZodType.prototype.openapi = function(refOrOpenapi, metadata) {
    var _a150, _b, _c, _d, _e2, _f;
    const openapi = typeof refOrOpenapi === "string" ? metadata : refOrOpenapi;
    const _g = openapi !== null && openapi !== void 0 ? openapi : {}, { param } = _g, restOfOpenApi = __rest(_g, ["param"]);
    const _internal = Object.assign(Object.assign({}, (_a150 = this._def.openapi) === null || _a150 === void 0 ? void 0 : _a150._internal), typeof refOrOpenapi === "string" ? { refId: refOrOpenapi } : void 0);
  ...
  zod.ZodObject.prototype.deepPartial = function() {
    ...
    Object.entries(resultShape).forEach(([key, value]) => {
      var _a150, _b;
      value._def.openapi = (_b = (_a150 = initialShape[key]) === null || _a150 === void 0 ? void 0 : _a150._def) === null || _b === void 0 ? void 0 : _b.openapi;
    });
...
var OpenAPIRegistry = class {
  ...
  get definitions() {
    var _a150, _b;
    const parentDefinitions = (_b = (_a150 = this.parents) === null || _a150 === void 0 ? void 0 : _a150.flatMap((par) => par.definitions)) !== null && _b !== void 0 ? _b : [];
  ...
  registerParameter(refId, zodSchema) {
    var _a150, _b, _c;
    const schemaWithRefId = this.schemaWithRefId(refId, zodSchema);
    const currentMetadata = (_a150 = schemaWithRefId._def.openapi) === null || _a150 === void 0 ? void 0 : _a150.metadata;
...
var Metadata = class {
  static getMetadata(zodSchema) {
    ...
    const zodDescription = (_a150 = zodSchema.description) !== null && _a150 !== void 0 ? _a150 : innerSchema.description;
    return {
  ...
  static getRefId(zodSchema) {
    var _a150;
    return (_a150 = this.getInternalMetadata(zodSchema)) === null || _a150 === void 0 ? void 0 : _a150.refId;
  }
...
var ArrayTransformer = class {
  transform(zodSchema, mapNullableType, mapItems) {
    ...
    return Object.assign(Object.assign({}, mapNullableType("array")), { items: mapItems(itemType), minItems: (_a150 = zodSchema._def.minLength) === null || _a150 === void 0 ? void 0 : _a150.value, maxItems: (_b = zodSchema._def.maxLength) === null || _b === void 0 ? void 0 : _b.value });
  }
};
...
var DiscriminatedUnionTransformer = class {
  ...
  mapDiscriminator(zodObjects, discriminator, generateSchemaRef) {
    ...
    zodObjects.forEach((obj) => {
      ...
      const value = (_a150 = obj.shape) === null || _a150 === void 0 ? void 0 : _a150[discriminator];
...
var ObjectTransformer = class {
  transform(zodSchema, defaultValue, mapNullableType, mapItem) {
    var _a150;
    const extendedFrom = (_a150 = Metadata.getInternalMetadata(zodSchema)) === null || _a150 === void 0 ? void 0 : _a150.extendedFrom;
...
var StringTransformer = class {
  transform(zodSchema, mapNullableType) {
    ...
    const length = (_a150 = this.getZodStringCheck(zodSchema, "length")) === null || _a150 === void 0 ? void 0 : _a150.value;
...
var OpenAPIGenerator = class {
  ...
  buildComponents() {
    ...
    this.rawComponents.forEach(({ componentType, name, component }) => {
      var _a151;
      (_a151 = rawComponents[componentType]) !== null && _a151 !== void 0 ? _a151 : rawComponents[componentType] = {};
      rawComponents[componentType][name] = component;
    });
    return Object.assign(Object.assign({}, rawComponents), { schemas: Object.assign(Object.assign({}, (_a150 = rawComponents.schemas) !== null && _a150 !== void 0 ? _a150 : {}), this.schemaRefs), parameters: Object.assign(Object.assign({}, (_b = rawComponents.parameters) !== null && _b !== void 0 ? _b : {}), this.paramRefs) });
  }
  sortDefinitions() {
  ...
  getParameterRef(schemaMetadata, external) {
    var _a150, _b, _c, _d, _e2;
    const parameterMetadata = (_a150 = schemaMetadata === null || schemaMetadata === void 0 ? void 0 : schemaMetadata.metadata) === null || _a150 === void 0 ? void 0 : _a150.param;
  ...
  generateInlineParameters(zodSchema, location) {
    ...
    const parameterMetadata = (_a150 = metadata === null || metadata === void 0 ? void 0 : metadata.metadata) === null || _a150 === void 0 ? void 0 : _a150.param;
    ...
    if (isZodType(zodSchema, "ZodObject")) {
      ...
      const parameters = Object.entries(propTypes).map(([key, schema]) => {
        ...
        const innerParameterMetadata = (_a151 = innerMetadata === null || innerMetadata === void 0 ? void 0 : innerMetadata.metadata) === null || _a151 === void 0 ? void 0 : _a151.param;
  ...
  generateSimpleParameter(zodSchema) {
    ...
    const paramMetadata = (_a150 = metadata === null || metadata === void 0 ? void 0 : metadata.metadata) === null || _a150 === void 0 ? void 0 : _a150.param;
  ...
  generateSchemaWithMetadata(zodSchema) {
    ...
    const result = ((_a150 = metadata === null || metadata === void 0 ? void 0 : metadata.metadata) === null || _a150 === void 0 ? void 0 : _a150.type) ? { type: metadata === null || metadata === void 0 ? void 0 : metadata.metadata.type } : this.toOpenAPISchema(innerSchema, zodSchema.isNullable(), defaultValue);
  ...
  constructReferencedOpenAPISchema(zodSchema) {
    ...
    if ((_a150 = metadata === null || metadata === void 0 ? void 0 : metadata.metadata) === null || _a150 === void 0 ? void 0 : _a150.type) {
  ...
  generateSimpleSchema(zodSchema) {
    ...
    const newMetadata = omitBy(Metadata.buildSchemaMetadata((_a150 = metadata === null || metadata === void 0 ? void 0 : metadata.metadata) !== null && _a150 !== void 0 ? _a150 : {}), (value, key) => value === void 0 || objectEquals(value, schemaRef[key]));
    if (newMetadata.type) {
      return {
...
// ../../node_modules/.pnpm/@hono+zod-validator@0.4.3_hono@4.12.22_zod@3.25.76/node_modules/@hono/zod-validator/dist/index.js
...
// ../../node_modules/.pnpm/@hono+zod-openapi@0.18.4_hono@4.12.22_zod@3.25.76/node_modules/@hono/zod-openapi/dist/index.mjs
var OpenAPIHono = /* @__PURE__ */ __name(class _OpenAPIHono extends Hono2 {
  ...
  route(path, app7) {
    ...
    super.route(path, app7);
    if (!(app7 instanceof _OpenAPIHono)) {
      return this;
    }
    app7.openAPIRegistry.definitions.forEach((def) => {
      switch (def.type) {
        case "component":
...
// ../../node_modules/.pnpm/@scalar+types@0.0.40/node_modules/@scalar/types/dist/api-reference/helpers/migrate-theme-variables.js
...
function migrateThemeVariables(styles) {
  const hasLegacyPrefixes = LEGACY_PREFIXES.some((p2) => styles.includes(p2));
...
__name(migrateThemeVariables, "migrateThemeVariables");

// ../../node_modules/.pnpm/@scalar+types@0.0.40/node_modules/@scalar/types/dist/api-reference/api-reference-configuration.js
var themeIdEnum = external_exports.enum([
  "alternate",
  "default",
  "moon",
  "purple",
...
var searchHotKeyEnum = external_exports.enum([
  "a",
  "b",
  "c",
  "d",
...
var integrationEnum = external_exports.enum([
  "adonisjs",
  "docusaurus",
  "dotnet",
  "elysiajs",
...
var specConfigurationSchema = external_exports.object({
   ...
   */
  content: external_exports.union([external_exports.string(), external_exports.record(external_exports.any()), external_exports.function().returns(external_exports.record(external_exports.any())), external_exports.null()]).optional(),
  /**
...
var pathRoutingSchema = external_exports.object({
  /** Base path for the API reference */
  basePath: external_exports.string()
});
var apiClientConfigurationSchema = external_exports.object({
  /** Prefill authentication */
  authentication: external_exports.any().optional(),
   ...
   * @default false
   */
  hideClientButton: external_exports.boolean().optional().default(false).catch(false),
  /** URL to a request proxy for the API client */
  proxyUrl: external_exports.string().optional(),
  /** Key used with CTRL/CMD to open the search modal (defaults to 'k' e.g. CMD+k) */
  searchHotKey: searchHotKeyEnum.optional(),
  /** List of OpenAPI server objects */
  servers: external_exports.array(external_exports.any()).optional(),
  // Using any for OpenAPIV3_1.ServerObject
  /**
   * Whether to show the sidebar
   * @default true
   */
  showSidebar: external_exports.boolean().optional().default(true).catch(true),
...
var _apiReferenceConfigurationSchema = apiClientConfigurationSchema.merge(external_exports.object({
  /**
   ...
   * @default false
   */
  hideDownloadButton: external_exports.boolean().optional().default(false).catch(false),
  /**
   ...
   */
  hiddenClients: external_exports.union([external_exports.record(external_exports.union([external_exports.boolean(), external_exports.array(external_exports.string())])), external_exports.array(external_exports.string()), external_exports.literal(true)]).optional(),
  ...
  onSpecUpdate: external_exports.function().args(external_exports.string()).returns(external_exports.void()).optional(),
  /** onServerChange is fired on selected server change */
  onServerChange: external_exports.function().args(external_exports.string()).returns(external_exports.void()).optional(),
  /**
   ...
   */
  generateHeadingSlug: external_exports.function().args(external_exports.object({ slug: external_exports.string().default("headingSlug") })).returns(external_exports.string()).optional(),
  /**
   ...
   */
  generateModelSlug: external_exports.function().args(external_exports.object({ name: external_exports.string().default("modelName") })).returns(external_exports.string()).optional(),
  /**
   ...
   */
  generateTagSlug: external_exports.function().args(external_exports.object({ name: external_exports.string().default("tagName") })).returns(external_exports.string()).optional(),
  /**
   ...
   */
  generateOperationSlug: external_exports.function().args(external_exports.object({
    path: external_exports.string(),
    operationId: external_exports.string().optional(),
    method: external_exports.string(),
    summary: external_exports.string().optional()
  })).returns(external_exports.string()).optional(),
  /**
   ...
   */
  generateWebhookSlug: external_exports.function().args(external_exports.object({
    name: external_exports.string(),
    method: external_exports.string().optional()
  })).returns(external_exports.string()).optional(),
  /** Callback fired when the reference is fully loaded */
  onLoaded: external_exports.function().returns(external_exports.void()).optional(),
  /**
   ...
   * ```
   */
  redirect: external_exports.function().args(external_exports.string()).returns(external_exports.string().nullable().optional()).optional(),
  /**
  ...
  defaultOpenAllTags: external_exports.boolean().optional(),
  /**
   * Function to sort tags
   * @default 'alpha' for alphabetical sorting
   */
  tagsSorter: external_exports.union([external_exports.literal("alpha"), external_exports.function().args(external_exports.any(), external_exports.any()).returns(external_exports.number())]).optional(),
  /**
   * Function to sort operations
   * @default 'alpha' for alphabetical sorting
   */
  operationsSorter: external_exports.union([external_exports.literal("alpha"), external_exports.literal("method"), external_exports.function().args(external_exports.any(), external_exports.any()).returns(external_exports.number())]).optional()
}));
var _apiReferenceConfigurationWithSourcesSchema = _apiReferenceConfigurationSchema.merge(external_exports.object({
  spec: external_exports.object({
    sources: external_exports.array(specConfigurationSchema)
  })
}));
var migrateConfiguration = /* @__PURE__ */ __name((_configuration) => {
...
// ../../node_modules/.pnpm/@scalar+types@0.0.40/node_modules/@scalar/types/dist/api-reference/html-rendering-configuration.js
...
// ../../node_modules/.pnpm/@scalar+core@0.1.1/node_modules/@scalar/core/dist/libs/html-rendering/index.js
var getHtmlDocument = /* @__PURE__ */ __name((configuration, customTheme2 = "") => {
...
var getScriptTagContent = /* @__PURE__ */ __name((configuration) => configuration.spec?.content ? typeof configuration.spec?.content === "function" ? JSON.stringify(configuration.spec?.content()) : JSON.stringify(configuration.spec?.content) : "", "getScriptTagContent");

// ../../node_modules/.pnpm/@scalar+hono-api-reference@0.5.184_hono@4.12.22/node_modules/@scalar/hono-api-reference/dist/honoApiReference.js
...
`;
var apiReference = /* @__PURE__ */ __name((givenConfiguration) => {
  const configuration = {
...
// ../../node_modules/.pnpm/hono@4.12.22/node_modules/hono/dist/middleware/pretty-json/index.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/entity.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/column.js
var _a;
var Column = class {
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/column-builder.js
var _a2;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/table.utils.js
var TableName = Symbol.for("drizzle:Name");

// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/foreign-keys.js
var _a3;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/tracing-utils.js
function iife(fn, ...args) {
  return fn(...args);
}
__name(iife, "iife");

// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/unique-constraint.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/utils/array.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/common.js
var _a8;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/enum.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/subquery.js
var _a16;
var Subquery = class {
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/version.js
var version2 = "0.39.3";

// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/tracing.js
var otel;
var rawTracer;
var tracer = {
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/view-common.js
var ViewBaseConfig = Symbol.for("drizzle:ViewBaseConfig");

// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/table.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/sql/sql.js
var _a19;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/alias.js
var _a26;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/errors.js
var _a29;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/sql/expressions/conditions.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/sql/expressions/select.js
function asc(column) {
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/logger.js
var _a31;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/query-promise.js
var _a34;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/utils.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/int.common.js
var _a35;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/bigint.js
var _a36;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/bigserial.js
var _a40;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/boolean.js
var _a44;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/char.js
var _a46;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/cidr.js
var _a48;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/custom.js
var _a50;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/date.common.js
var _a52;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/date.js
var _a53;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/double-precision.js
var _a57;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/inet.js
var _a59;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/integer.js
var _a61;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/interval.js
var _a63;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/json.js
var _a65;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/jsonb.js
var _a67;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/line.js
var _a69;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/macaddr.js
var _a73;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/macaddr8.js
var _a75;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/numeric.js
var _a77;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/point.js
var _a79;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/postgis_extension/utils.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/postgis_extension/geometry.js
var _a83;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/real.js
var _a87;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/serial.js
var _a89;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/smallint.js
var _a91;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/smallserial.js
var _a93;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/text.js
var _a95;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/time.js
var _a97;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/timestamp.js
var _a99;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/uuid.js
var _a103;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/varchar.js
var _a105;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/vector_extension/bit.js
var _a107;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/vector_extension/halfvec.js
var _a109;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/vector_extension/sparsevec.js
var _a111;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/vector_extension/vector.js
var _a113;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/columns/all.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/table.js
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/primary-keys.js
var _a116;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/relations.js
var _a118;
var Relation = class {
...
// ../../node_modules/.pnpm/drizzle-zod@0.7.1_drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+ser_zwakpu5tnpjzaxpkanhl7t4uty/node_modules/drizzle-zod/index.mjs
var CONSTANTS = {
  INT8_MIN: -128,
  INT8_MAX: 127,
...
var Ai = I((Dh, _i) => {
  ...
  var Aa = a(function(r) {
    ...
    r(
      ...
      1005,
      Yt
    ), r(1007, Yt), r(1028, Yt), r(1016, _a150), r(1017, Aa), r(1021, Zt), r(1022, Zt), r(1231, Zt), r(1014, ne2), r(1015, ne2), r(1008, ne2), r(1009, ne2), r(1040, ne2), r(1041, ne2), r(1115, Jt), r(
      1182,
      Jt
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/selection-proxy.js
var _a122;
...
_a122 = entityKind;
__publicField(SelectionProxyHandler, _a122, "SelectionProxyHandler");

// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/query-builders/delete.js
var _a123;
...
_a123 = entityKind;
__publicField(PgDeleteBase, _a123, "PgDelete");

// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/casing.js
...
_a124 = entityKind;
__publicField(CasingCache, _a124, "CasingCache");

// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/view-base.js
var _a125;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/dialect.js
var _a126;
var PgDialect = class {
  /** @internal */
  casing;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/query-builders/query-builder.js
var _a127;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/query-builders/select.js
var _a128;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/query-builders/query-builder.js
var _a131;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/query-builders/insert.js
var _a132;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/query-builders/refresh-materialized-view.js
var _a134;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/query-builders/update.js
var _a135;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/query-builders/count.js
var _a137;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/query-builders/query.js
var _a138;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/query-builders/raw.js
var _a140;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/db.js
var _a141;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/pg-core/session.js
var _a142;
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/neon-http/session.js
var rawQueryConfig = {
  arrayMode: false,
  fullResults: true
};
...
// ../../node_modules/.pnpm/drizzle-orm@0.39.3_@cloudflare+workers-types@4.20260523.1_@neondatabase+serverless@0.10.4_@types+pg@8.11.6/node_modules/drizzle-orm/neon-http/driver.js
var _a148;
...
var categorySelectSchema = createSelectSchema(menuCategories);
var categoryInsertSchema = createInsertSchema(menuCategories).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var categoryUpdateSchema = categoryInsertSchema.partial();
var menuItemSelectSchema = createSelectSchema(menuItems);
var menuItemInsertSchema = createInsertSchema(menuItems).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var menuItemUpdateSchema = menuItemInsertSchema.partial();
...
app.openapi(
  ...
  async (c) => {
    ...
    const rows = await db.select().from(menuItems).where(conditions.length ? and(...conditions) : void 0).orderBy(asc(menuItems.name));
    return c.json(rows);
  }
);
app.openapi(
...
function applyAction(current, action) {
  ...
  if (!next) {
    throw new HTTPException(422, {
      message: `Cannot '${action}' an order in '${current}' state. Valid actions: ${getValidActions(current).join(", ") || "none"}`
    });
  }
  return next;
}
...
__name(getValidActions, "getValidActions");
...
var orderActionSchema = external_exports.object({
  action: external_exports.enum(ORDER_ACTIONS)
});
var createOrderItemSchema = external_exports.object({
...
var createOrderSchema = external_exports.object({
  ...
  items: external_exports.array(createOrderItemSchema).min(1)
});
var settingsSchema = external_exports.object({
  prepTimeMins: external_exports.number().int().min(1).max(120).optional(),
  autoAccept: external_exports.boolean().optional(),
  isOpen: external_exports.boolean().optional(),
  openingHours: external_exports.object({
    monday: external_exports.object({ open: external_exports.string(), close: external_exports.string(), closed: external_exports.boolean() }).optional(),
    tuesday: external_exports.object({ open: external_exports.string(), close: external_exports.string(), closed: external_exports.boolean() }).optional(),
    wednesday: external_exports.object({ open: external_exports.string(), close: external_exports.string(), closed: external_exports.boolean() }).optional(),
    thursday: external_exports.object({ open: external_exports.string(), close: external_exports.string(), closed: external_exports.boolean() }).optional(),
    friday: external_exports.object({ open: external_exports.string(), close: external_exports.string(), closed: external_exports.boolean() }).optional(),
    saturday: external_exports.object({ open: external_exports.string(), close: external_exports.string(), closed: external_exports.boolean() }).optional(),
    sunday: external_exports.object({ open: external_exports.string(), close: external_exports.string(), closed: external_exports.boolean() }).optional()
  }).optional()
});

// src/routes/customers.ts
var app2 = new OpenAPIHono();
var customerSelectSchema = createSelectSchema(customers);
var customerInsertSchema = createInsertSchema(customers).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
var customerUpdateSchema = customerInsertSchema.partial();
var errorSchema2 = external_exports.object({ message: external_exports.string() });
var customerWithStatsSchema = customerSelectSchema.extend({
        ...
        content: {
          "application/json": {
            schema: external_exports.object({
              data: external_exports.array(customerWithStatsSchema),
...
var orderItemSelectSchema = createSelectSchema(orderItems);
var errorSchema3 = external_exports.object({ message: external_exports.string() });
var orderWithDetailsSchema = orderSelectSchema.extend({
  items: external_exports.array(orderItemSelectSchema),
  customer: createSelectSchema(customers).nullable(),
  validActions: external_exports.array(external_exports.string())
});
app3.openapi(
  createRoute({
    tags: ["orders"],
    ...
    request: {
      query: paginationSchema.extend({
        status: external_exports.enum(orderStatusEnum.enumValues).optional(),
        customerId: external_exports.string().uuid().optional(),
  ...
  async (c) => {
    ...
    if (from)
      conditions.push(sql`${orders.createdAt} >= ${new Date(from)}`);
    if (to2)
      conditions.push(sql`${orders.createdAt} <= ${new Date(to2)}`);
    ...
    const rows = await db.select({
      ...
      itemCount: sql`count(${orderItems.id})::int`,
...
app3.openapi(
  ...
  async (c) => {
    ...
    if (body.customerId) {
      ...
      if (!customer2)
        throw new HTTPException(422, { message: "Customer not found" });
    }
    ...
    const insertedItems = await db.insert(orderItems).values(lineItems.map((item) => ({ ...item, orderId: order.id }))).returning();
    let customer = null;
    if (body.customerId) {
      const [c2] = await db.select().from(customers).where(eq(customers.id, body.customerId));
      customer = c2 ?? null;
    }
    return c.json(
      {
...
app3.openapi(
  ...
  async (c) => {
    ...
    const [updated] = await db.update(orders).set({
      ...
      completedAt: nextStatus === "completed" ? /* @__PURE__ */ new Date() : order.completedAt
...
var settingsResponseSchema = external_exports.object({
  prepTimeMins: external_exports.number(),
  autoAccept: external_exports.boolean(),
  isOpen: external_exports.boolean(),
  openingHours: external_exports.record(external_exports.any())
});
...
var statsSchema = external_exports.object({
  totalOrdersToday: external_exports.number(),
  revenueTodayCents: external_exports.number(),
  pendingOrders: external_exports.number(),
  avgPrepTimeMins: external_exports.number(),
  totalOrdersAllTime: external_exports.number(),
  revenueAllTimeCents: external_exports.number(),
  popularItems: external_exports.array(
    external_exports.object({
      id: external_exports.string(),
      name: external_exports.string(),
      orderCount: external_exports.number(),
      priceCents: external_exports.number()
    })
  ),
  recentOrders: external_exports.array(external_exports.any()),
  ordersByStatus: external_exports.record(external_exports.number())
});
app5.openapi(
  createRoute({
    tags: ["home"],
  ...
  async (c) => {
    ...
    const [todayStats] = await db.select({
      ...
      revenue: sql`coalesce(sum(${orders.totalCents}), 0)::int`
    }).from(orders).where(gte(orders.createdAt, todayStart));
    const [pendingCount] = await db.select({ count: sql`count(*)::int` }).from(orders).where(eq(orders.status, "pending"));
    ...
    const popularItems = await db.select({
      ...
      orderCount: sql`count(${orderItems.id})::int`
    }).from(orderItems).innerJoin(menuItems, eq(menuItems.id, orderItems.menuItemId)).groupBy(menuItems.id).orderBy(sql`count(${orderItems.id}) desc`).limit(5);
    const recentOrders = await db.select().from(orders).orderBy(sql`${orders.createdAt} desc`).limit(10);
...
app6.route("/menu", app);
app6.route("/customers", app2);
app6.route("/orders", app3);
app6.route("/settings", app4);
app6.route("/home", app5);
app6.doc("/openapi.json", {
  openapi: "3.0.0",
...
app6.get("/", (c) => c.json({ status: "ok", version: "1.0.0" }));
app6.onError((err, c) => {
...
// .wrangler/tmp/bundle-1HuSBs/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-1HuSBs/middleware-loader.entry.ts
